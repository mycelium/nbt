	...
	<div class="container content">
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="span10">
				<form id="newModule" name="newModule" action="${api_url}/newModule/add" method="POST">
					<h3>Create New Module</h3>
				</div><br>
				<div class="span5">
					<h5>Title</h5>
					<input id="moduleCaption" name="moduleCaption" type="text" placeholder="Title" required> 		
					<br>
					<h5>Description</h5>
					<textarea rows="7" input id="moduleDescription" name="moduleDescription" placeholder="Description"></textarea>
					<h5>Attach Tasks:</h5>
